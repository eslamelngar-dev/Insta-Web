          ...
          {Object.values(TEMPLATES_REGISTRY).map((template) => {
            ...
            return (
              <motion.div 
                key={template.id}
                whileHover={{ y: -5 }}
                className="bg-white dark:bg-slate-900/40 rounded-[2.5rem] border border-slate-200 dark:border-white/5 overflow-hidden flex flex-col group transition-all hover:border-indigo-500/30 shadow-xl shadow-slate-200/20 dark:shadow-none w-full max-w-md mx-auto"
              >
                ...
                <div className="p-8 relative z-10 bg-white dark:bg-slate-900/40">
                  ...
                  <Link 
                    ...
                    className="w-full py-4 bg-indigo-600 text-white rounded-xl font-black text-[10px] uppercase tracking-[0.2em] flex items-center justify-center gap-2 hover:bg-indigo-500 transition-all shadow-xl shadow-indigo-600/20 active:scale-95 pointer-events-auto"
                  >
