...
const BENTO_BLOCK_TYPES: BentoBlockType[] = [
  {
    type: "profile",
    icon: User,
    label: "Profile",
...
const BENTO_DEFAULTS: Record<string, BlockData> = {
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                <p className="text-[8px] font-black text-teal-500 uppercase ml-1">
                  Latitude
                </p>
                <input
                  type="number"
    ...
    <div className="space-y-6 sm:space-y-10 pb-32">
      <div className="grid grid-cols-3 gap-2.5">
        {BENTO_BLOCK_TYPES.map((b) => (
          <button
            key={b.type}
            onClick={() => addBentoBlock(b.type, BENTO_DEFAULTS[b.type])}
