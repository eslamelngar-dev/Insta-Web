...
// تعريف الـ Variants لتجنب خطأ الـ Build
...
export default function NotFound() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center p-6 text-slate-900 dark:text-white font-sans overflow-hidden">
      ...
      >
        <div className="w-24 h-24 bg-white dark:bg-slate-900 rounded-[2rem] border border-slate-200 dark:border-white/10 shadow-xl flex items-center justify-center mx-auto mb-8">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mb-10 leading-relaxed font-medium">
          The link you followed might be broken, or the page may have been removed. The good news? <span className="text-indigo-500 font-bold">This username is still available.</span>
        </p>
        ...
        <div className="mt-8">
          <Link href="/" className="text-[10px] font-bold text-slate-400 hover:text-slate-600 dark:hover:text-white uppercase tracking-widest transition-colors">
            Return to Homepage
          </Link>
        </div>
      </motion.div>
