...
export const TEMPLATES_REGISTRY: Record<string, TemplateConfig> = {
  ...
  bento: {
    ...
    pageType: "social",
    tier: "premium",
    tags: ["grid", "bento", "interactive", "modern"],
    isFeatured: true,
    schemaVersion: 1,
    defaultContent: {
      color: "#6366f1",
  ...
  nexus: {
    ...
    pageType: "landing",
    tier: "premium",
    tags: ["landing", "agency", "portfolio", "sections", "business"],
    isFeatured: true,
    schemaVersion: 1,
    defaultContent: {
      color: "#6366f1",
  ...
  glass: {
    ...
    pageType: "social",
    tier: "free",
    tags: ["glass", "blur", "dark", "aesthetic", "modern"],
    schemaVersion: 1,
    defaultContent: {
  ...
  terminal: {
    ...
    pageType: "social",
    tier: "free",
    tags: ["developer", "terminal", "cli", "dark", "code"],
    schemaVersion: 1,
    defaultContent: {
      title: "Dev_Username",
  ...
  notion: {
    ...
    pageType: "social",
    tier: "free",
    tags: ["notion", "document", "clean", "minimal", "light"],
    schemaVersion: 1,
    defaultContent: {
      title: "Your Name",
  ...
  formcraft: {
    ...
    pageType: "form",
    tier: "premium",
    tags: ["form", "contact", "leads", "survey", "drag-drop"],
    isFeatured: true,
    schemaVersion: 1,
    defaultContent: {
      color: "#6366f1",
